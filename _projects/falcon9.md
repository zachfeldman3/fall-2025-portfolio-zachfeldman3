...
## 1. Engine Base Module (Merlin Engines + Rocket Base)
...
The base of the rocket includes a hollow internal cavity and a cylindrical press-fit piece insert with an alignment feature. This internal core provides:
...
<div style="display:flex; gap:40px; justify-content:center; align-items:flex-start; margin:40px 0; flex-wrap:wrap;">
  ...
  <!-- Image 1 -->
  <div style="text-align:center;">
    <img src="{{ '/assets/images/interstage.png' | relative_url }}"
         style="height:350px; width:auto; border-radius:12px; display:block; margin:0 auto;" />
    <p style="margin-top:10px; font-style:italic; color:#555;">
      Interstage
    </p>
  ...
  <!-- Image 2 (Middle - wider automatically) -->
  <div style="text-align:center;">
    <img src="{{ '/assets/images/interstage2.png' | relative_url }}"
         style="height:350px; width:auto; border-radius:12px; display:block; margin:0 auto;" />
    <p style="margin-top:10px; font-style:italic; color:#555;">
  ...
  <!-- Image 3 -->
  <div style="text-align:center;">
    <img src="{{ '/assets/images/gridfin.png' | relative_url }}"
         style="height:350px; width:auto; border-radius:12px; display:block; margin:0 auto;" />
    <p style="margin-top:10px; font-style:italic; color:#555;">
      Grid Fin 
    </p>
...
- PLA warping and shrink effects
...
- Final press-fit interfaces were designed around a clearance of approximately 0.01 inches for consistent friction-fit assembly
...
- Circular patterning for structural symmetry
